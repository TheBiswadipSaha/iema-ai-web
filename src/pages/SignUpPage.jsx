...
export default function SignUpPage() {
  ...
  const handleSocialSignUp = (provider) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert(`${provider} sign up initiated! In production, this would redirect to ${provider}'s OAuth page.`);
    }, 1000);
  };
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button 
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-2 py-3 bg-[#0f0f0f] border border-gray-700 rounded-xl hover:border-emerald-500/50 hover:bg-[#1a1a1a] transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed"
              >
