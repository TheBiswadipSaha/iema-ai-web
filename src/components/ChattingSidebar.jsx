...
export const ChattingSidebar = ({ pageConfig }) => {
  const [filters, setFilters] = useState({});

  const handleFilterChange = (section, option, value) => {
    setFilters(prev => ({
      ...prev,
      [section]: {
        ...prev[section],
  ...
  return (
    ...
    <div key={idx} className="mb-4">
        ...
        <div className="flex flex-wrap gap-2 w-auto">
            ...
            const isActive =
                filters?.[filterSection.heading] === option.label;
            ...
            return (
                ...
                onClick={() =>
                    ...
                    [filterSection.heading]:
                        isActive ? null : option.label // toggle + only one active
                    }))
                }
                className={`
